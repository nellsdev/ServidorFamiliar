...
cat > /etc/php/8.2/fpm/pool.d/nextcloud.conf << 'PHPFPM'
[nextcloud]
user = www-data
group = www-data
...
systemctl enable nginx mariadb php8.2-fpm avahi-daemon
systemctl restart nginx mariadb php8.2-fpm avahi-daemon
